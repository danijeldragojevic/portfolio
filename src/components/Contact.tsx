    ...
    <section id="contact" className="py-20 bg-darkCard">
      <div className="container mx-auto px-6">
        <div className="flex flex-col items-center text-center mb-12">
          <span className="text-sm uppercase tracking-wider text-highlight/80 mb-2">Get In Touch</span>
          <h2 className="section-heading">Contact Me</h2>
        </div>
        
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-10">
          <div className="animate-fade-in">
            <h3 className="text-xl font-semibold text-darkText mb-6">Contact Information</h3>
          ...
          <div className="animate-fade-in" style={{ animationDelay: "0.2s" }}>
            <h3 className="text-xl font-semibold text-darkText mb-6">Send Me a Message</h3>
            
            <form className="space-y-4">
              <div>
                <label htmlFor="name" className="text-sm text-darkSubtle block mb-1">Name</label>
                <input 
                  type="text" 
                  id="name" 
              ...
              <div>
                <label htmlFor="email" className="text-sm text-darkSubtle block mb-1">Email</label>
                <input 
                  type="email" 
                  id="email" 
                  className="w-full px-4 py-2 bg-darkBg border border-white/10 rounded-lg focus:outline-none focus:border-highlight/50 text-darkText"
              ...
              <div>
                <label htmlFor="message" className="text-sm text-darkSubtle block mb-1">Message</label>
                <textarea 
                  id="message" 
                  rows={4} 
